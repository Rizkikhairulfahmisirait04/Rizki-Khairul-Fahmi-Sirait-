...
<html>
    ...
    <body onload="print()">
        ...
        $sql = "SELECT * FROM surat_masuk WHERE no_surat='" . $_GET ['id'] . "'";
                ...
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <table class="table table-bordered table-striped table-hover"> 
							...
							<thead>
								<tr>
									<th width="18%">Nomor Surat</th><th>Nama Penerima</th><th width="15%"><center>Tanggal Masuk</center></th><th width="10%">Nama Pengirim</th><th><center>Instansi</center></th><th><center>Status</center></th>
								</tr>
								</thead>
								<td><?= $data['no_surat'] ?></td>
